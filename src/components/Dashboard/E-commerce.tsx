...
const ECommerce: React.FC = ({ 
  ...
  //Caso Ocorra algum erro com as requisições no servidor.
    ...
    const formattedAmount = balance.toLocaleString("en-US", {style:"currency", currency:"USD"});
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-1 md:gap-6 xl:grid-cols-1 2xl:gap-7.5">
        ...
        <CardDataStats title="Saldo Total" total={`${DataAccount?.currency  } ${formattedAmount}`} rate="4.35%" levelUp>
